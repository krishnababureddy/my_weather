...
import '/viewmodels/get_hourly_forecast_provider.dart';
...
class HourlyForecastView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final hourlyWeatherAsync = ref.watch(hourlyForecastProvider);
    ...
    return hourlyWeatherAsync.when(
      data: (response) {
        ...
        final hourlyForecast = response.hourlyweather!;
        return SizedBox(
          height: 100,
